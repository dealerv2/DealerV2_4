...
extern char server_dir[] ;    /* Typically EXE_DIR aka /usr/local/games/DealerV2_4/bin */
extern char server_path[];    /* server_dir followed by pgm name DealerServer see globals.c */
...
/* Global vars for communication between Flex and Bison, and Dealer */
...
#endif
 extern short int   ltc_weights[13] ;       /* Weight that allows coding the top cards in a suit. A=32, K=16, Q=8, J=4, T=2 x=1*/
 extern short int   points[13] ;            /* Goren (or other) HCP values A=4, K=3 etc. */
 /* the pointcount array of various point count arrays. Needs the file pointcount.h to be included with this file.*/
 extern short int	tblPointcount [idxEnd][13] ;
 ...
 extern short int	CardAttr_RO [idxEndRO][13] ;
